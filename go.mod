...
require (
	...
	github.com/openshift/osde2e-common v0.0.0-20240614071722-55c7b3f8ec72
)
...
replace (
	github.com/onsi/ginkgo/v2 v2.19.0 => github.com/onsi/ginkgo/v2 v2.9.5
	github.com/onsi/gomega v1.33.1 => github.com/onsi/gomega v1.27.7
)
